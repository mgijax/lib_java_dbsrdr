...
public class DP_RPCI_ClonesKey
{
    /////////////////
    //  Variables  //
    /////////////////

    // The primary key for a record in the DP_RPCI_Clones table.
    //
    private Integer key;


    /**
     * Constructs a new DP_RPCI_ClonesKey object.
     * @assumes Nothing
     * @effects Nothing
     * @param None
     ...
     * @throws DBException
     */
    public DP_RPCI_ClonesKey ()
        throws ConfigException, DBException
    {
        SQLDataManager sqlMgr = SQLDataManagerFactory.getShared("RADAR");
        key = Table.getInstance("DP_RPCI_Clones",sqlMgr).getNextKey();
    }
     ...
     * @throws Nothing
     */
    public DP_RPCI_ClonesKey (Integer pKey)
    {
        key = pKey;
    }
