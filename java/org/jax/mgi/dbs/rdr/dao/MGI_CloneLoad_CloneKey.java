...
public class MGI_CloneLoad_CloneKey
{
    /////////////////
    //  Variables  //
    /////////////////
    ...
    /**
     * Constructs a new MGI_CloneLoad_CloneKey object.
     * @assumes Nothing
     * @effects Nothing
     * @param None
     ...
     * @throws DBException
     */
    public MGI_CloneLoad_CloneKey ()
        throws ConfigException, DBException
    {
        SQLDataManager sqlMgr = SQLDataManagerFactory.getShared("RADAR");
        key = Table.getInstance("MGI_CloneLoad_Clone",sqlMgr).getNextKey();
    }
     ...
     * @throws Nothing
     */
    public MGI_CloneLoad_CloneKey (Integer pKey)
    {
        key = pKey;
    }
