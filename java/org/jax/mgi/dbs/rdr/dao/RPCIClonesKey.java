...
public class RPCIClonesKey
{
    ...
    /**
     * Constructs a new RPCIClonesKey object.
     * @assumes Nothing
     * @effects Nothing
     * @param None
     ...
     * @throws DBException
     */
    public RPCIClonesKey ()
        throws ConfigException, DBException
    {
        SQLDataManager sqlMgr = SQLDataManagerFactory.getShared("RADAR");
        primaryKey = Table.getInstance("DP_RPCI_Clones",sqlMgr).getNextKey();
    }
     ...
     * @throws Nothing
     */
    public RPCIClonesKey (Integer pKey)
    {
        primaryKey = pKey;
    }
